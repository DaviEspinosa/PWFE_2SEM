//------- CARROSSEL -------
const carouselVisible = document.querySelector(".carrossel-visivel");
const carousel = carouselVisible.querySelector(".carousel");
const prevButton = document.querySelectorAll(".prev-Item");
const nextButton = document.querySelectorAll(".next-Item");
